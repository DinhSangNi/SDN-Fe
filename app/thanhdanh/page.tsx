    ...
    const informations = [
        {
            ...
            description: `  Tôi là học sinh cấp 3, luôn nỗ lực học tập và rèn luyện bản thân mỗi ngày. 
                            Tôi yêu thích các môn như Toán, Tin học và Tiếng Anh, đồng thời tích cực tham gia các 
                            hoạt động ngoại khóa để phát triển kỹ năng mềm. Tôi mong muốn được học hỏi nhiều hơn 
                            để chuẩn bị tốt cho tương lai và định hướng nghề nghiệp sau này. `,
            name: 'Thanh Danh',
            age: 18,
            address: 'An Nhon'
        }
